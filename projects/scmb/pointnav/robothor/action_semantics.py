...
class AS_PointNavRoboThorRGBPPOExperimentConfig(PointNavRoboThorBaseConfig,):
    """An Point Navigation experiment configuration in RoboThor with RGB
    input."""

    CERTAIN_ACTION_STATE_CHANGE_EMBED = list(range(16))
    ...
    def tag(self):
        return "PointNav-RoboTHOR-RGB-ResNet-AS-DDPPO"
