...
from projects.scmb.pointnav.pointnav_base import PointNavBaseConfig

if ai2thor.__version__ not in ["0.0.1", None] and version.parse(
    ai2thor.__version__
) < version.parse("2.7.2"):
    raise ImportError(
        "To run the PointNav baseline pointnav you must use"
...
class PointNavThorBaseConfig(PointNavBaseConfig, ABC):
    ...
    def __init__(self):
        ...
        self.headless = self.DEFAULT_THOR_IS_HEADLESS
